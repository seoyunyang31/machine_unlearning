# Machine Unlearning at UofT TMI

This project explores machine unlearning techniques with a recommendation system baseline using the NCF model on the KuaiRec dataset.

Trained weight of NCF model can be found at https://huggingface.co/seoyuny/social_media_ncf
KauiRec dataset can be found at https://kuairec.com/
